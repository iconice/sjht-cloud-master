...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    /**
     *********************************************************
     * @Title: dateStrToStamp
     * @Description: 字符串时间转换时间戳
     * @Param: dateStr 时间字符串
     ...
     **********************************************************
     */
    public static long dateStrToStamp(String dateStr, String dateFormat) throws Exception {
     ...
     **********************************************************
     */
    public static Date timeStamp2Date(String millisecond) {
        return new Date(Long.valueOf(millisecond));
    }
     ...
     * @Description: 得到当前时间的前后自分钟
     * @Param: minute 负数代表前 正数代表后
     * @Param: dateFormat 转换格式
     * @Return: String 时间字符串
     * @Author maojianyun
     **********************************************************
     */
    public static String getTimeByMinute(int minute, String dateFormat) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.MINUTE, minute);
        return new SimpleDateFormat(dateFormat).format(calendar.getTime());
    }

    public static void getymdhms() {
     ...
     *********************************************************
     * @Title: stepMonth
     * @Description: 在给定的日期加上或减去指定月份后的日期
     ...
     *
     * @Title: diffSeconds
     * @Description: 计算两个日期相差秒数。 用第一个日期减去第二个。如果前一个日期小于后一个日期，则返回负数
     * @Param: one 第一个日期数，作为基准
     * @Param: two 第二个日期数，作为比较
     * @Return: long 两个日期相差秒数
     * @Author maojianyun
     **********************************************************
     */
...
//        DateUtils.
     ...
     *
     * @Title: diffDays
     * @Description: 计算两个日期相差天数。 用第一个日期减去第二个。如果前一个日期小于后一个日期，则返回负数
     * @Param: one 第一个日期数，作为基准
     * @Param: two 第二个日期数，作为比较
    ...
    public static int diffDays(Date one, Date two) {
        return (int) ((one.getTime() - two.getTime()) / (24 * 60 * 60 * 1000));
    }

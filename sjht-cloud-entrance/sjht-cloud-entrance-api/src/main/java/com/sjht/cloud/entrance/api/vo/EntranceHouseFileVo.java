...
@Data
@ToString
@ApiModel(value = "EntranceHouseFileVo", description = "房产文件vo")
public class EntranceHouseFileVo implements Serializable {

    private static final long serialVersionUID = -1285849030273832152L;

    @ApiModelProperty(name = "id", value = "文件idid", required = true)
    private String id;
    ...
    @ApiModelProperty(name = "subType", value = "子类型：5-购房合同、6-贷款抵押合同、7-房屋登记证明、8-其他（在type=2时使用）", required = false)
    private int subType;
